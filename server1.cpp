...
//	const char* delim = "\r\n";
//	/*
//	strtok_s(char *_s, const char *_delimiter, char **_Context)用来将字符串分割成一个个片段。
//	参数s指向欲分割的字符串，
...
//	//如果是本地地址，hostent->h_addr_list[0][0] = 127
...
////线程执行函数
//unsigned int _stdcall ProxyThread(LPVOID lpParameter) {
//	//int ret_c = ioctlsocket(((ProxyParam*)lpParameter)->cilentSocket, FIONBIO, (unsigned long*)&ul);
//	//int ret_s = ioctlsocket(((ProxyParam*)lpParameter)->serverSocket, FIONBIO, (unsigned long*)&ul);
...
//		printf("https");
//		/*printf("https");
//		char* loc1,*loc2,*temp1,*temp2;
//		int len;
//		temp1 = new char[MAXSIZE] {'0'};
//		temp2 = new char[MAXSIZE] {'0'};
//		loc1 = strstr(Buffer, (char*)"\r\n");
//		strcpy_s(temp1, strlen(loc1)+1, loc1);
//		*loc1 = '\0';
//		printf("%s", Buffer);
//		printf("%s", temp1);
//		loc2 = strstr(temp1, (char*)":443");
//		strcpy_s(temp2, strlen(loc2 + 4) + 1, loc2 + 4);
//		*loc2 = '\0';
//		strcat_s(temp1, strlen(temp1) + strlen(temp2)+1, temp2);
//		strcat_s(Buffer, strlen(temp1) + strlen(Buffer)+1, temp1);
//		printf("%s", Buffer);*/
//		/*判断为http连接还是https连接
//        如果为https连接，返回客户端应答*/
//		const char* s;
